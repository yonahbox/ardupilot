...
const AP_Param::GroupInfo AP_MotorsHeli_Single::var_info[] = {
    ...
    // @Range: 0 2000
    // @User: Standard
    AP_GROUPINFO("RSC_GV_OPEN_A", 22, AP_MotorsHeli_Single, _main_rotor._open_a, 0),
    ...
    // @Range: 0 2000
    // @User: Standard
    AP_GROUPINFO("RSC_GV_OPEN_B", 23, AP_MotorsHeli_Single, _main_rotor._open_b, 0),
    ...
    // @Range: 0 2000
    // @User: Standard
    AP_GROUPINFO("RSC_GV_OPEN_C", 24, AP_MotorsHeli_Single, _main_rotor._open_c, 0),
    ...
    // @Range: 0 2000
    // @User: Standard
    AP_GROUPINFO("RSC_GV_OPEN_D", 25, AP_MotorsHeli_Single, _main_rotor._open_d, 0),  
    ...
    // @Range: 0 2000
    // @User: Standard
    AP_GROUPINFO("RSC_GV_OPEN_E", 26, AP_MotorsHeli_Single, _main_rotor._open_e, 0),

    // @Param: RSC_GV_OPEN_MODE
    // @DisplayName: Open Loop controller mode
    // @Description: 0: Disabled, 1: Linear 2: Quadratic
    // @User: Standard
    AP_GROUPINFO("RSC_GV_OPEN_MD", 27, AP_MotorsHeli_Single, _main_rotor._open_mode, 0),
    ...
    // @Range: 0 2000
    // @User: Standard
    AP_GROUPINFO("RSC_GV_OPEN_NA", 28, AP_MotorsHeli_Single, _main_rotor._open_neg_a, 0),
    ...
    // @Range: 0 2000
    // @User: Standard
    AP_GROUPINFO("RSC_GV_OPEN_NB", 29, AP_MotorsHeli_Single, _main_rotor._open_neg_b, 0),
    ...
    // @Range: 0 2000
    // @User: Standard
    AP_GROUPINFO("RSC_GV_OPEN_NC", 30, AP_MotorsHeli_Single, _main_rotor._open_neg_c, 0),
    ...
    // @Range: 0 2000
    // @User: Standard
    AP_GROUPINFO("RSC_GV_OPEN_ND", 31, AP_MotorsHeli_Single, _main_rotor._open_neg_d, 0),   
    ...
    // @Range: 0 2000
    // @User: Standard
    AP_GROUPINFO("RSC_GV_OPEN_NE", 32, AP_MotorsHeli_Single, _main_rotor._open_neg_e, 0),
