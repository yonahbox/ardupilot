...
#define AC_PID_NDF_FILT_HZ_DEFAULT  20.0f   // default input filter frequency
#define AC_PID_NDF_FILT_HZ_MIN      0.01f   // minimum input filter frequency
...
public:
    ...
    // Constructor for PID
    AC_PID_NDF(float initial_p, float initial_i, float initial_d, float initial_imax, float initial_filt_hz, float dt);
